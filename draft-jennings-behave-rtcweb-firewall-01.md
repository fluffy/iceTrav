...
The firewall looks for an outbound ICE connectivity check and allows inbound ICE
...
* STUN packets are only allowed “in” if they know the 128 bit (TODO CHECK) crypto random
